...
[~,~,~,mtar_eia,mtar_scanpos,mtar_idx_asc,mttime,mtar_lat,mtar_lon] = sub_uniqmean(tar_ID,tar_eia,tar_scanpos,tar_idx_asc,tar_time,tar_lat,tar_lon);

% filter with EIA difference
eia_diff = mtar_eia-mref_eia;
idx = abs(eia_diff(:,1))<Collocate.eia; % 1=same scanpos,2=same/adjacent scanpos
[mlat,mlon,mref_lat,mref_lon,mref_tb_obs,mref_eia,mref_time,mref_scanpos,mtar_lat,mtar_lon,mtar_tb_obs,mtar_eia,mttime,mtar_scanpos] = ...
    sub_filterInd1D(1,idx,mlat,mlon,mref_lat,mref_lon,mref_tb_obs,mref_eia,mref_time,mref_scanpos,mtar_lat,mtar_lon,mtar_tb_obs,mtar_eia,mttime,mtar_scanpos);
...
mtimedif = (mttime-mref_time)*24*60; % time difference, minutes
mtar_tb_dif = mtar_tb_obs-mref_tb_obs;
meia_diff = mtar_eia-mref_eia;
