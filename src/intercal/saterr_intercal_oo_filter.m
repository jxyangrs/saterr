...
if 1
    ...
    idxfil = idxfil | idx;
    % apply filter
    [tar_tb_obs,tar_qual,tar_tb_obs,tar_eia,tar_lat,tar_lon,tar_time,tar_azm,tar_scanpos,tar_scanangle,tar_idx_asc] = ...
        sub_filterInd1D(1,~idxfil, tar_tb_obs,tar_qual,tar_tb_obs,tar_eia,tar_lat,tar_lon,tar_time,tar_azm,tar_scanpos,tar_scanangle,tar_idx_asc);
end
...
if 1
    ...
    idxfil = idxfil | idx;
    % apply filter
    [ref_tb_obs,ref_qual,ref_tb_obs,ref_eia,ref_lat,ref_lon,ref_time,ref_azm,ref_scanpos,ref_scanangle,ref_idx_asc] = ...
        sub_filterInd1D(1,~idxfil, ref_tb_obs,ref_qual,ref_tb_obs,ref_eia,ref_lat,ref_lon,ref_time,ref_azm,ref_scanpos,ref_scanangle,ref_idx_asc);
end
% filter of quality flag
if 1
