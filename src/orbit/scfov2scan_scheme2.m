function [sc_azc,sc_scannadir,sc_scanaz] = scfov2scan_scheme2(fov_lat,fov_lon,fov_h,sc_lat,sc_lon,sc_h)
% determine spacecraft scanning
% sc_azc is calculated with SC lat&lon&h, rather than FOV and SC
% 
% Input:
...
sc_azc = scgeo2scaz(sc_lat,sc_lon,sc_h);
