function [t_datenum,lat,lon,eia,cc,cw,cs,tw,tb,wn,ind_tw,altitude,ang_az] = read_bin_KLM_mhs_L1B(inpath,infile)
...
%   cc,             count of space view,                      3D [ncrossCal,nscanline,channel]
%   cw,             count of warm-load,                       3D [ncrossCal,nscanline,channel]
%   cs,             count of scene,                           3D [90,nscanline,channel]
%   tw,             temperature of warm-load (K),             2D [nPRT,nscanline]
...
%   ind_tw,         unique index of tw,                       1D [1,ind...]
...
nscanline = fread(fid,[1,1],'uint16'); % number of data record; 
