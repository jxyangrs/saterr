...
% Read a single orbital file of AMSR-E (PPS HDF5 format)
%   e.g. 1C.AQUA.AMSRE.XCAL2017-V.20050101-S003558-E021450.014167.V05A.HDF5
%
% Input:
...
%
% Output:
%       tb_low,     brightness temperature;     [crosstrack(196),alongtrack(~3956),channel(8)] (10-36 GHz)
...
%       tb_high,    brightness temperature;     [crosstrack(392),alongtrack,channel(2)] (89 GHz)
...
%
% Description:
%       AMSR-E channels in PPS 1C
%       low:  '6.925V','6.925H','10.65V','10.65H','18.7V','18.7H','23.8V','23.8H','36.5V','36.5H'
%       high: '89V','89H'
% 
...
eia_low = cat(1,eia1,eia2,eia3,eia4);
eia_high = cat(1,eia5,eia6);
